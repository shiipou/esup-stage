...
/**
 * Gestion des exceptions de l'API du projet Ces exceptions ne sont prises en charge que s'il y a eu passage dans un controller si exception dans un cronjob,
 * pendant la phase d'auth, ..., l'exception n'est pas catché
 * 
 * @author David
 */
...
public class ApiExceptionHandler {
	...
	protected ApiError handleMissingServletRequestParameter(MissingServletRequestParameterException ex, WebRequest request) {
	...
	protected ApiError handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex, WebRequest request) {
	...
	protected ApiError handleMethodArgumentNotValid(MethodArgumentNotValidException ex, WebRequest request) {
	...
	protected ApiError handleConstraintViolation(javax.validation.ConstraintViolationException ex, WebRequest request) {
	...
	protected ApiError handleHttpMessageNotReadable(HttpMessageNotReadableException ex, WebRequest request) {
	...
	protected ApiError handleHttpMessageNotWritable(HttpMessageNotWritableException ex, WebRequest request) {
	...
	protected ApiError handleNoHandlerFoundException(NoHandlerFoundException ex, WebRequest request) {
		ApiError error = buildErrorObject(request, HttpStatus.BAD_REQUEST, ex, messageService.getMessage("exception.internal"));
		errorComponent.sendMail(error);
		return error;
	}
	...
	protected ApiError handleEntityNotFound(EntityNotFoundException ex, WebRequest request) {
	...
	protected ApiError handleEntityNotFound(javax.persistence.EntityNotFoundException ex, WebRequest request) {
		ApiError error = buildErrorObject(request, HttpStatus.NOT_FOUND, ex, messageService.getMessage("exception.notfound"));
		errorComponent.sendMail(error);
		return error;
	}
	...
	protected ApiError handleDataIntegrityViolation(DataIntegrityViolationException ex, WebRequest request) {
		ApiError error = buildErrorObject(request, HttpStatus.INTERNAL_SERVER_ERROR, ex, messageService.getMessage("exception.internal"));
	...
	protected ApiError handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, WebRequest request) {
		ApiError error = buildErrorObject(request, HttpStatus.BAD_REQUEST, ex, messageService.getMessage("exception.internal"));
		errorComponent.sendMail(error);
		return error;
	}
	...
	protected ApiError handleException(Exception ex, WebRequest request) {
		ApiError error = buildErrorObject(request, HttpStatus.INTERNAL_SERVER_ERROR, ex, "exception.internal");
		errorComponent.sendMail(error);
		return error;
	}
